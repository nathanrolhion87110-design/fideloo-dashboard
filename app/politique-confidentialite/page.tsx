      ...
      <div className="max-w-3xl mx-auto">
        ...
        <GlassCard variant="strong" className="p-8 space-y-6 text-text-main">
          <Section title="1. Responsable du traitement">
            <p>Nathan Rolhion — <a href="mailto:contact@fideloo.fr" style={{ color: "var(--violet)" }} className="hover:text-white">contact@fideloo.fr</a></p>
          </Section>
          ...
          <Section title="6. Vos droits">
            ...
            <p className="text-text-muted mt-2">
              ...
              <a href="mailto:contact@fideloo.fr" style={{ color: "var(--violet)" }} className="hover:text-white">contact@fideloo.fr</a>.
