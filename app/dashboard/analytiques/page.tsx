...
export default function AnalyticsPage() {
  ...
  const kpis = [
    ...
    { title: "Points distribués", value: totalPoints, color: "#a78bfa" },
                ...
                <LineChart data={clientData} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
                  <defs>
                    <linearGradient id="lineGradient" x1="0" y1="0" x2="1" y2="0">
                      ...
                      <stop offset="100%" stopColor="#8b6dfb" />
                    </linearGradient>
                  </defs>
                  ...
                  <Tooltip
                    contentStyle={{ borderRadius: "12px", border: "1px solid rgba(167,139,250,0.4)", background: "rgba(8,8,8,0.95)", color: "#F5F0E8", fontSize: "13px", boxShadow: "0 20px 40px rgba(0,0,0,0.5)" }}
              ...
              <tbody className="divide-y divide-white/5">
                {topClients.map((c, i) => (
                  <tr key={c.id} className="hover:bg-white/[0.03] transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-extrabold text-right" style={{ color: "var(--violet)" }}>{c.points}</td>
                  </tr>
                ))}
              </tbody>
            </table>
